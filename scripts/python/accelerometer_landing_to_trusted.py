...
'''
JoinCustomerPrivacy_node1723177813819 = sparkSqlQuery(glueContext, query = SqlQuery6451, mapping = {"cusTrusted":CustomerTrusted_node1723177756499, "accLanding":AccelerometerLanding_node1723177753375}, transformation_ctx = "JoinCustomerPrivacy_node1723177813819")
...
AccelerometerTrustedZone_node1723177985674.writeFrame(JoinCustomerPrivacy_node1723177813819)
job.commit()